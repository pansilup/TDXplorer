...
binding_state_ofst: 0xd90
attributes_ofst: 0x80
op_state ofst: 0x8
tdcs_start_pa: 0x4001f000
tdx call: 48
########## issuing SEAMCALL TDH_SERVTD_BIND ----------------------------------------
########## 0376 SEAMCALL TDH_SERVTD_BIND SEAMRET status: 0 SUCCESS -----------------
############# TD 1 LEFECYCLE STATE: TD_KEYS_CONFIGURED
############# TD 1 OP STATE: OP_STATE_INITIALIZED
RCX: 0x2744c73e58708d5c
RDX: 0x40000000
R10: 0x2744c73e186ead64
R11: 0x2744c73e186ead65
R12: 0x2744c73e186ead66
R13: 0x2744c73e186ead67
Ending current test case.
...
tdx call: 10
########## issuing SEAMCALL TDH_VP_CREATE ----------------------------------------
########## 0377 SEAMCALL TDH_VP_CREATE SEAMRET status: 0 SUCCESS -----------------
############# TD 1 LEFECYCLE STATE: TD_KEYS_CONFIGURED
############# TD 1 OP STATE: OP_STATE_INITIALIZED
tdvps pa: 40025000
...
tdx call: 4
########## issuing SEAMCALL TDH_VP_ADDCX ----------------------------------------
########## 0391 SEAMCALL TDH_VP_ADDCX SEAMRET status: 0 SUCCESS -----------------
############# TD 1 LEFECYCLE STATE: TD_KEYS_CONFIGURED
############# TD 1 OP STATE: OP_STATE_INITIALIZED
tdx call: 22
########## issuing SEAMCALL TDH_VP_INIT ----------------------------------------
########## 0392 SEAMCALL TDH_VP_INIT SEAMRET status: 0 SUCCESS -----------------
############# TD 1 LEFECYCLE STATE: TD_KEYS_CONFIGURED
############# TD 1 OP STATE: OP_STATE_INITIALIZED
...
tdx call: 3
########## issuing SEAMCALL TDH_MEM_SEPT_ADD ----------------------------------------
########## 0396 SEAMCALL TDH_MEM_SEPT_ADD SEAMRET status: 0 SUCCESS -----------------
############# TD 1 LEFECYCLE STATE: TD_KEYS_CONFIGURED
############# TD 1 OP STATE: OP_STATE_INITIALIZED
R8: ffffffffffffffff
...
tdx call: 2
########## issuing SEAMCALL TDH_MEM_PAGE_ADD ----------------------------------------
########## 0400 SEAMCALL TDH_MEM_PAGE_ADD SEAMRET status: 0 SUCCESS -----------------
############# TD 1 LEFECYCLE STATE: TD_KEYS_CONFIGURED
############# TD 1 OP STATE: OP_STATE_INITIALIZED
tdx call: 16
########## issuing SEAMCALL TDH_MR_EXTEND ----------------------------------------
...
tdx call: 16
########## issuing SEAMCALL TDH_MR_EXTEND ----------------------------------------
########## 0464 SEAMCALL TDH_MR_EXTEND SEAMRET status: 0 SUCCESS -----------------
############# TD 1 LEFECYCLE STATE: TD_KEYS_CONFIGURED
############# TD 1 OP STATE: OP_STATE_INITIALIZED
tdx call: 17
########## issuing SEAMCALL TDH_MR_FINALIZE ----------------------------------------
########## 0465 SEAMCALL TDH_MR_FINALIZE SEAMRET status: 0 SUCCESS -----------------
############# TD 1 LEFECYCLE STATE: TD_KEYS_CONFIGURED
...
lp: 0 khole idx: 119 ref count:0 hkid+pa with active mapping: 8400040001000
lp: 0 khole idx: 120 ref count:0 hkid+pa with active mapping: 8400040002000
lp: 0 khole idx: 121 ref count:0 hkid+pa with active mapping: 8400040003000
lp: 0 khole idx: 122 ref count:0 hkid+pa with active mapping: 8400040004000
lp: 0 khole idx: 123 ref count:0 hkid+pa with active mapping: 8400040005000
lp: 0 khole idx: 124 ref count:0 hkid+pa with active mapping: 8400040006000
...
lp khole tot ref count: 0
tdx call: 18
########## issuing TDCALL TDG_SERVTD_RD ----------------------------------------

########## VMRESUME TD 0 resumed ----------------------------------
TDCALL TDG_SERVTD_RD TDCALL status: 0 SUCCESS -----------------
RCX: 0x2744c73e58708d5c
RDX: 0x8010000300000021
R8: 0x2744c73e186ead64
R9: 0x0
R10: 0x2744c73e186ead64
R11: 0x2744c73e186ead65
