...
class EFlagsManager {
    ...
    public:
        ...
        std::set<KVExprPtr> one_constraint;
        std::set<KVExprPtr> m_Constraint_back;
        KVExprPtr last_constraint;

        std::map<std::string, unsigned long long> last_solved_constraints;
        ...
        bool SolveNegatedConstraints();
        bool SolveOneConstraint();
